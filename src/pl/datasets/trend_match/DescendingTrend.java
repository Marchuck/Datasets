 ...
 */
public class DescendingTrend extends TrendingSubsetWrapper {


    public static DescendingTrend getInstance(List<DatasetItem> dataset) {
        return new DescendingTrend(dataset);
    }



    private DescendingTrend(List<DatasetItem> dataset) {
        super(dataset);
        setMinTrendLength(2);
    }
